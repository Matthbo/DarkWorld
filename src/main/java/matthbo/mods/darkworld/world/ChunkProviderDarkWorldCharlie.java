...
public class ChunkProviderDarkWorldCharlie implements IChunkProvider {
    ...
    public ChunkProviderDarkWorldCharlie(World world, long par2, boolean par3, String par4)
    {
        this.field_177476_s = ModFluids.darkWaterBlock;
        this.stoneNoise = new double[256];
        this.caveGenerator = new MapGenDarkWorldCaves();
        this.strongholdGenerator = new MapGenStronghold();
        this.villageGenerator = new MapGenVillage();
        this.mineshaftGenerator = new MapGenMineshaft();
        this.scatteredFeatureGenerator = new MapGenScatteredFeature();
        this.ravineGenerator = new MapGenDarkWorldRavine();
        ...
        if (par4 != null)
        {
            this.settings = ChunkProviderSettings.Factory.func_177865_a(par4).func_177864_b();
            this.field_177476_s = this.settings.useLavaOceans ? ModFluids.darkLavaBlock : ModFluids.darkWaterBlock;
        }
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int j3 = 0; j3 < 4; ++j3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_180518_3_.setBlockState(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, ModBlocks.darkStone.getDefaultState());
                                }
    ...
    public void populate(IChunkProvider provider, int par2, int par3)
    {
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(provider, worldObj, rand, par2, par3, flag));
        ...
        if (biomegenbase != ModBiomes.darkDesert /*&& biomegenbase != ModBiomes.darkdesertHills TODO*/ && this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0
                && TerrainGen.populate(provider, worldObj, rand, par2, par3, flag, LAKE))
        {
            k1 = this.rand.nextInt(16) + 8;
            l1 = this.rand.nextInt(256);
            i2 = this.rand.nextInt(16) + 8;
            (new DarkWorldGenLakes(ModFluids.darkWaterBlock)).generate(this.worldObj, this.rand, blockpos.add(k1, l1, i2));
        }

        if (TerrainGen.populate(provider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes)
        {
            k1 = this.rand.nextInt(16) + 8;
            ...
            {
                (new DarkWorldGenLakes(ModFluids.darkLavaBlock)).generate(this.worldObj, this.rand, blockpos.add(k1, l1, i2));
            }
        }

        if (this.settings.useDungeons)
        {
            boolean doGen = TerrainGen.populate(provider, worldObj, rand, par2, par3, flag, DUNGEON);
        ...
        if (TerrainGen.populate(provider, worldObj, rand, par2, par3, flag, ANIMALS))
        {
            SpawnerAnimals.performWorldGenSpawning(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
        }
        blockpos = blockpos.add(8, 0, 8);

        boolean doGen = TerrainGen.populate(provider, worldObj, rand, par2, par3, flag, ICE);
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Post(provider, worldObj, rand, par2, par3, flag));
    ...
    public boolean func_177460_a(IChunkProvider provider, Chunk chunk, int par3, int par4)
    {
        ...
        {
            flag |= this.oceanMonumentGenerator.func_175794_a(this.worldObj, this.rand, new ChunkCoordIntPair(par3, par4));
        }
    ...
    public void recreateStructures(Chunk chunk, int par2, int par3)
    {
        if (this.settings.useMineShafts && this.mapFeaturesEnabled)
        {
            this.mineshaftGenerator.func_175792_a(this, this.worldObj, par2, par3, (ChunkPrimer)null);
        }

        if (this.settings.useVillages && this.mapFeaturesEnabled)
        {
            this.villageGenerator.func_175792_a(this, this.worldObj, par2, par3, (ChunkPrimer)null);
        }

        if (this.settings.useStrongholds && this.mapFeaturesEnabled)
        {
            this.strongholdGenerator.func_175792_a(this, this.worldObj, par2, par3, (ChunkPrimer)null);
        }

        if (this.settings.useTemples && this.mapFeaturesEnabled)
        {
            this.scatteredFeatureGenerator.func_175792_a(this, this.worldObj, par2, par3, (ChunkPrimer)null);
        }

        if (this.settings.useMonuments && this.mapFeaturesEnabled)
        {
            this.oceanMonumentGenerator.func_175792_a(this, this.worldObj, par2, par3, (ChunkPrimer)null);
        }
    }
