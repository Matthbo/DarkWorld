...
public class ChunkProviderDarkWorldBeta implements IChunkProvider{
    ...
    public void func_147424_a(int p_147424_1_, int p_147424_2_, Block[] p_147424_3_)
    {
        ...
        for (int k = 0; k < 4; ++k)
        {
            ...
            for (int j1 = 0; j1 < 4; ++j1)
            {
                ...
                {
                    double d0 = 0.125D;
                    double d1 = this.double1[k1 + k2];
                    double d2 = this.double1[l1 + k2];
                    double d3 = this.double1[i2 + k2];
                    double d4 = this.double1[j2 + k2];
                    double d5 = (this.double1[k1 + k2 + 1] - d1) * d0;
                    double d6 = (this.double1[l1 + k2 + 1] - d2) * d0;
                    double d7 = (this.double1[i2 + k2 + 1] - d3) * d0;
                    double d8 = (this.double1[j2 + k2 + 1] - d4) * d0;
    ...
    private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_)
    {
        ...
        double d2 = 512.0D;
        double d3 = 512.0D;
        this.double5 = this.noiseGen6.generateNoiseOctaves(this.double5, p_147423_1_, p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
        this.double2 = this.noiseGen3.generateNoiseOctaves(this.double2, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
        this.double3 = this.noiseGen1.generateNoiseOctaves(this.double3, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        this.double4 = this.noiseGen2.generateNoiseOctaves(this.double4, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        boolean flag1 = false;
        boolean flag = false;
        int l = 0;
        int i1 = 0;
        ...
        for (int j1 = 0; j1 < 5; ++j1)
        {
            for (int k1 = 0; k1 < 5; ++k1)
            {
                ...
                double d12 = this.double5[i1] / 8000.0D;
                ...
                for (int j2 = 0; j2 < 33; ++j2)
                {
                    ...
                    double d7 = this.double3[l] / 512.0D;
                    double d8 = this.double4[l] / 512.0D;
                    double d9 = (this.double2[l] / 10.0D + 1.0D) / 2.0D;
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (biomegenbase != ModBiomes.darkDesert && !flag && this.rand.nextInt(4) == 0
            && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
            k1 = k + this.rand.nextInt(16) + 8;
            l1 = this.rand.nextInt(256);
            i2 = l + this.rand.nextInt(16) + 8;
            (new DarkWorldGenLakes(ModFluids.darkWaterBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        ...
        if (TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new DarkWorldGenLakes(ModFluids.darkLavaBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
