...
public class BlockDarkFire extends BlockFire {
	...
	public BlockDarkFire() {
		super();
		this.setUnlocalizedName("darkfire");
    ...
    public void onBlockAdded(World world, BlockPos pos, IBlockState state){
    	if(!(world.provider.getDimensionId() == 0 || world.provider.getDimensionId() == ModDimensions.dimensionIDDarkWorld) || !ModBlocks.darkworldPortal.func_176548_d(world, pos)){
    ...
    //TODO: change Blocks.fire to ModBlocks.darkFire (if it finally works)
