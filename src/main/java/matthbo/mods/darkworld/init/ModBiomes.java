...
public class ModBiomes {
	...
	public static void init(){
		...
		darkTaiga = (DarkBiomeGenBase) new BiomeDarkTaiga(105, 0).setColor(747097).setBiomeName("Dark Taiga").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(DarkBiomeGenBase.height_MidPlains);
